...
!(function (t, e) {
    ...
    h = (function () {
      ...
      return (
        (e.get = function get(t, e) {
          ...
          return (
            (n = parseFloat(e ? i.v1 : i.g(i.t, i.p)) - parseFloat(i.v2)),
            (r = i.rCap) &&
              (n %= r) !== n % (r / 2) &&
              (n = n < 0 ? n + r : n - r),
            (function _round(t) {
        ...
        (e.remove = function remove(t) {
          ...
          i &&
            ...
            (n = i._next),
            e && (e._next = n),
            n ? (n._prev = e) : o === i && (a.remove(r), (o = 0)),
        ...
        (VelocityTracker.track = function track(e, n, r) {
          ...
          for (
            ...
            for (i = q(s[f]) || new VelocityTracker(s[f]), o = c.length; o--; )
              i.add(c[o], u[o] || u[0]);
            a.push(i);
          }
          return a;
  ...
  function ea(t, e, n, r, i, o, a) {
    ...
    if (((n = isNaN(n) ? $ : n), (r = isNaN(r) ? -$ : r), O(e))) {
      if (
        ((s = e.calculated ? e : (P(u) ? u(e, a) : da(e, u, n, r, o)) || e),
        !e.calculated)
      ) {
        for (c in s) e[c] = s[c];
        e.calculated = !0;
  ...
  var v,
    ...
    B = S(103, 115, 97, 112, 46, 99, 111, 109),
    ...
    G = {
      ...
      init: function init(t, e, n, r, i) {
        ...
        var a,
          ...
          k = N(y)
            ? y
            : (function _calculateTweenDuration(t, e, n, r, i, o) {
                if (
                  (void 0 === n && (n = 10),
                  void 0 === r && (r = 0.2),
                  void 0 === i && (i = 1),
                ...
                for (a in ((h = ja(t, m, S, w)), m))
                  z[a] ||
                    ((s = m[a]),
                    O(s) ||
                      ((d = d || C(t)) && d.isTracking(a)
                        ? (s = N(s) ? { velocity: s } : { velocity: d.get(a) })
                        : ((u = +s || 0), (c = Math.abs(u / w)))),
                    O(s) &&
                      ((u = N(s.velocity)
                        ? s.velocity
                        : (d = d || C(t)) && d.isTracking(a)
                      ...
                      "max" in s && l > +s.max + 1e-10
                        ? ((p = s.unitFactor || x.unitFactors[a] || 1),
                          (g =
                            (f > s.max && s.min !== s.max) ||
                            (-15 < u * p && u * p < 45)
                              ? r + 0.1 * (n - r)
        ...
        for (a in ((e = M), (M = 0), (p = ja(t, e, v, w)), e))
          z[a] ||
            ((s = e[a]),
            P(s) && (s = s(r, t, i)),
            N(s)
            ...
            O(s) &&
              ((g = c + l),
              "end" in s &&
                (s = ea(s, p && a in p ? p : g, s.max, s.min, a, e.radius, f)),
              "max" in s && +s.max < g
